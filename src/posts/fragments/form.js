...
import FieldSeoTitle from "../fields/seoTitle";
import FieldSeoDescription from "../fields/seoDescription";
import FieldRef from "../fields/ref";
    ...
    children: function UIForm(props) {
      ...
      return (
        <Form>
          ...
          <Link href="/panel/posts" passHref={true}>
